...
from mgraph_client.device_management import DeviceManagement, ManagedDevices


@pytest.fixture
def device_management(client):
    return DeviceManagement(client)
...
def managed_devices(
    ...
    return ManagedDevices(
        device_management._client, data=managed_devices_data, parent=device_management
    )
